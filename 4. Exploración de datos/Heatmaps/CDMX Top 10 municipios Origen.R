...
3.
### Gr√°fico municipios de origen por tipo de transporte
ggplot(filter(municipio.transporte.o, n > 2)) +
  ...
  facet_wrap(municipios_origen~., scales = "free_x",  strip.position = "top") + ylab("N˙mero de viajes") +
...
### Gr√°fico municipios de origen por taxi libre
...
### Gr√°fico municipios de origen por Taxi de Sitio
